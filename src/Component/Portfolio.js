...
import Gallery_1 from '../Assets/Images/gallery/lr-logo-edited.png';
import Gallery_2 from '../Assets/Images/gallery/insight-logo-edited.png';
                        ...
                        <div className="col col-xs-12 sortable-gallery">
                            ...
                            <div className="gallery-container gallery-fancybox masonry-gallery tumho-masonary">
                                ...
                                <div className={this.state.onPrintDesign ? "grid active" : "grid"
                                   ...
                                   <img src={Gallery_1} className="img img-responsive" alt="Laurel Road" />
                                    <div className="icon">
